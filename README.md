...
Данный проект предназначен для вычисления математических и тригонометрческих вычислений выражений, записанных в простом текстовом формате. Это доработка кода из книги Франческо Балены "Программирование на VB.NET для профессионалов".
